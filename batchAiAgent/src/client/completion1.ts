...
//const rawRequestFilename = "/tmp/rawfile-" + rawFileCounter++ + "-request.json";
//await Deno.writeTextFile(rawRequestFilename, JSON.stringify(postData, null, 4));
...
//const rawResponseFilename = "/tmp/rawfile-" + rawFileCounter++ + "-response.json";
//await Deno.writeTextFile(rawResponseFilename, JSON.stringify(obj, null, 4));
